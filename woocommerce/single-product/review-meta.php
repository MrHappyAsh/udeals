...
<?php } else { ?>
	...
	<p class="meta">
		...
		?>
		<span class="woocommerce-review__dash">&ndash;</span> <small>Reviewed on <time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></time></small>
	</p>
